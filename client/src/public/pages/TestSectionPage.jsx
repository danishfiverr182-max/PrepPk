            ...
            >
              ...
              {currentMcq ? (
                <div className="space-y-6 mcq-no-copy" {...noCopyProps}>
                  ...
                  {currentMcq.imageUrl ? (
                    // Stacks vertically on mobile and scrolls via the outer
                    // <main> only; the right panel only gets its own
                    // `overflow-y-auto` from `lg:` up (alongside the split's
                    // fixed height), so phones never have two nested scroll
                    // containers fighting each other.
                    <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:h-[74vh] h-auto min-h-0">
                      <div className="lg:w-[62%] w-full bg-white border border-slate-200 dark:bg-slate-900 dark:border-slate-800 rounded-2xl sm:rounded-3xl p-2 sm:p-3 lg:p-4 shadow-lg overflow-hidden flex flex-col min-h-0 lg:h-full h-[32vh] sm:h-[38vh]">
                      ...
                      <div className="lg:w-[38%] w-full min-w-0 flex-shrink-0 lg:overflow-y-auto min-h-0">
