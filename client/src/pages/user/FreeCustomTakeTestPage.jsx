            ...
            <div className="shrink-0 border-t border-slate-200 dark:border-slate-850 bg-white dark:bg-slate-900 px-3 sm:px-6 py-3 sm:py-4">
              ...
              >
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-slate-600 dark:text-slate-350 hover:text-brand disabled:opacity-40 border border-slate-200 dark:border-slate-800 px-3.5 sm:px-5 py-2.5 sm:py-3 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-all select-none shrink-0"
                >
